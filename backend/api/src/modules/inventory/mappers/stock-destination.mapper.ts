...
export class StockDestinationMapper {
  static toDomain(destination: PrismaStockDestination): StockDestination {
    switch (destination) {
      ...
      default:
        throw new Error(`Unknown Prisma StockDestination: ${destination}`);
    }
  }

  static toPrisma(destination: StockDestination): PrismaStockDestination {
    switch (destination) {
      ...
      default:
        throw new Error(`Unknown Domain StockDestination: ${destination}`);
    }
  }
}
