...
export class SavedAddressTypeMapper {
  static toDomain(type: PrismaSavedAddressType): SavedAddressType {
    switch (type) {
      ...
      default:
        throw new Error(`Unknown Prisma SavedAddressType: ${type}`);
    }
  }

  static toPrisma(type: SavedAddressType): PrismaSavedAddressType {
    switch (type) {
      ...
      default:
        throw new Error(`Unknown Domain SavedAddressType: ${type}`);
    }
  }
}
