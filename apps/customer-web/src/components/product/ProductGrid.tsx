...
export default function ProductGrid() {
  ...
  const showProductShimmer = showShimmer || (loading && !isNoOutlet && !needsLocation);

  return (
    <section className="relative bg-white py-0">
      {showShimmer && !isNoOutlet && !isError && !needsLocation && (
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6">
        ...
        {!isNoOutlet && !needsLocation && selectedOutlet && products.length > 0 && (
